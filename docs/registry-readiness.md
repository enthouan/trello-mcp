...
This document completes the requirements audit in
[issue #57](https://github.com/enthouan/trello-mcp/issues/57). It records the
submission path and the work that later issues must complete. It does not add
registry metadata, generate `tools.json`, perform live Trello calls, change the
release workflow, or claim that Docker Registry acceptance or supply-chain
readiness is complete.

| Source | Audited revision | Why it matters |
| --- | --- | --- |
| Docker MCP Registry `main` | [`fd36a38a452e54a166a6cd3413ba2ff726361d24`](https://github.com/docker/mcp-registry/tree/fd36a38a452e54a166a6cd3413ba2ff726361d24) | Commit-pinned source for every upstream requirement and example below. |
| `trello-mcp` `origin/main` | [`e8d265f77c66453e42aedee628ad426dac366e75`](https://github.com/enthouan/trello-mcp/commit/e8d265f77c66453e42aedee628ad426dac366e75) | Current source, Dockerfile, configuration, and documentation snapshot used for the mapping. |
...
change independently, so issues #58 and #62 must re-fetch `main`, record the new
SHA, and re-audit any changed requirements before preparing metadata or opening
the external pull request.
...
- [ ] Reconfirm all eligibility facts at the final source commit selected by
  #58 and again immediately before #62 opens the external pull request.
...
| Tags | At minimum `trello`, `productivity`, and `project-management`; #58 must recheck current catalog vocabulary and avoid implying an official Atlassian integration |
...
| Icon | A stable public PNG, JPEG, SVG, WebP, or favicon URL selected in #58; verify it is retrievable and within the current upstream size constraints |
| `source.project` | `https://github.com/enthouan/trello-mcp` |
| `source.commit` | The exact lowercase 40-character source commit selected at submission time; never a branch, short SHA, or tag ([source pinning][registry-source-pinning], [pin validator][registry-pin-validator]) |
...
- [ ] Format `server.yaml` with upstream's current Prettier expectations and run
...
- [ ] Keep `TRANSPORT` fixed to `stdio`, not exposed as a user parameter. The
  Docker image defaults to HTTP, so the registry entry must override it.
- [ ] Keep `LOG_LEVEL` fixed to `info`, not exposed in the initial credential
...
- [ ] Do not include `PORT` or `MCP_AUTH_TOKEN`. They govern the HTTP transport
  and do not apply to the initial stdio registry entry.
- [ ] Do not override `run.command`; the image's existing command is correct and
...
- [ ] Confirm the two secret fields are presented as required credential inputs
  in Docker Desktop and that no example resembles a real key or token.
...
There is no evidence in the 2026-08-15 snapshots that blocks the Docker-built
...
[registry-pr-template]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/.github/PULL_REQUEST_TEMPLATE.md#L9-L30
[registry-build-path]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/CONTRIBUTING.md#L138-L159
[registry-notion]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/servers/notion/server.yaml#L1-L22
[registry-supadata]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/servers/supadata/server.yaml#L1-L25
[registry-prerequisites]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/CONTRIBUTING.md#L28-L34
[registry-server-types]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/pkg/servers/types.go#L35-L136
[registry-configuration]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/docs/configuration.md#L26-L90
[registry-name-title-validation]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/cmd/validate/main.go#L94-L167
[registry-source-pinning]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/docs/configuration.md#L78-L90
[registry-pin-validator]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/cmd/validate/main.go#L185-L208
[registry-validation]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/cmd/validate/main.go#L37-L84
[registry-tools-fallback]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/CONTRIBUTING.md#L162-L197
[registry-tool-model]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/internal/mcp/types.go#L43-L61
[registry-taskfile]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/Taskfile.yml#L3-L50
[registry-ci]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/.github/workflows/ci.yaml#L1-L75
[registry-post-acceptance]: https://github.com/docker/mcp-registry/blob/fd36a38a452e54a166a6cd3413ba2ff726361d24/CONTRIBUTING.md#L199-L205
