...
description: "Configure trello-mcp over local stdio or Streamable HTTP in supported MCP clients."
editUrl: "https://github.com/enthouan/trello-mcp/edit/main/docs/client-setup.md"
---
...
[MCP Client Compatibility](/clients/compatibility/).
...
<figure class="transport-chooser" data-transport-chooser>
  <div class="transport-chooser__viewport" data-transport-chooser-scroll role="region" aria-label="Transport chooser diagram" tabindex="0">
    <img src="/transport-chooser.svg" alt="Transport chooser showing local stdio and service-oriented Streamable HTTP paths" width="1200" height="600" />
  </div>
  <figcaption>
...
[Trello API Key](/trello-api-key/). Keep both values out of
...
[published Docker setup](/get-started/docker/) or
[local Docker build](/get-started/docker/#local-docker-build). The
