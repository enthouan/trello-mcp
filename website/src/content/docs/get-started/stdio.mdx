...
3. **Set the transport and credentials.** [Create a Trello API key and token](/trello-api-key/), then pass `TRANSPORT=stdio`, `TRELLO_API_KEY`, and `TRELLO_TOKEN` in the child-process environment.
