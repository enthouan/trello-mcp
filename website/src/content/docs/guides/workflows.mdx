...
editUrl: "https://github.com/enthouan/trello-mcp/edit/main/docs/workflows.md"
---
...
[Set up your MCP client](/clients/) first if the tools are not visible, or
[Trello API Key](/trello-api-key/) if the credentials are not configured.
...
- Review the [API Coverage](/tools/api-coverage/) page when a prompt assumes a Trello
