...
them with the [Trello API key guide](/getting-started/trello-api-key/), then keep them in a
...
Use the client-specific format in [Set up your MCP client](/getting-started/clients/). Do not
...
Continue with [Set up your MCP client](/getting-started/clients/), or compare the complete
startup commands in the [README quick start](/getting-started/).
