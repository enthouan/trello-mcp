...
description: "Every trello-mcp runtime and Compose setting, its default, and the boundary it controls."
editUrl: "https://github.com/enthouan/trello-mcp/edit/main/docs/configuration.md"
---
...
:::caution[Keep configuration private]
`TRELLO_TOKEN` grants the configured member's
...
them with the [Trello API Key guide](/trello-api-key/), then keep them in a
...
Use the client-specific format in [Set up your MCP client](/clients/). Do not
...
The checked-in [`docker-compose.yml`](https://github.com/enthouan/trello-mcp/blob/main/docker-compose.yml) and
[`docker-compose.local.yml`](https://github.com/enthouan/trello-mcp/blob/main/docker-compose.local.yml) do not forward
...
The default [`docker-compose.yml`](https://github.com/enthouan/trello-mcp/blob/main/docker-compose.yml) runs the published
image. [`docker-compose.local.yml`](https://github.com/enthouan/trello-mcp/blob/main/docker-compose.local.yml) builds the
...
Continue with [Set up your MCP client](/clients/), or compare the complete
startup commands in the [README quick start](/get-started/).
