...
| Vulnerability, credential exposure, authentication bypass, or a report that requires private details | Follow [SECURITY.md](/reference/security-policy/) and use GitHub private vulnerability reporting. Do not open a public issue. |
...
[SECURITY.md](/reference/security-policy/) and use GitHub private vulnerability reporting from
