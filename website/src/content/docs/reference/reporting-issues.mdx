...
| Vulnerability, credential exposure, authentication bypass, or a report that requires private details | Follow [SECURITY.md](/reference/security-policy/) and use GitHub private vulnerability reporting. If that is unavailable, open only a short non-sensitive public request for a private reporting path. |
...
Follow [SECURITY.md](/reference/security-policy/) and use GitHub private vulnerability reporting
