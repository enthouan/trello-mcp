...
[MCP Client Compatibility](/getting-started/compatibility/).
...
[Trello API key](/getting-started/trello-api-key/). Keep both values out of
...
[published Docker setup](/getting-started/docker/) or
[local Docker build](/getting-started/docker/#local-docker-build). The
